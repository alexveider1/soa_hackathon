...
class HitPrediction():
    ...
    def __init__(
        ...
        if model_type not in ALLOWED_MODELS: 
            raise ValueError(
                f"""Model is not in allowed models: {ALLOWED_MODELS}""" 
            )
    ...
    def _prepare_features(self, X: pd.DataFrame, fit_encoder: bool = False) -> pd.DataFrame:
        """
