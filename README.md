# Решение хакатона Школы Анализа Данных 2025–2026

## Структура репозитория

| Путь | Назначение |
|---|---|
| `data/` | Исходные данные. Содержит `spotify_data.csv` (~1.16 млн треков, аудио-признаки + жанр). Не коммитится в git. |
| `task_1/` | Задача 1 |
| `task_2/` | Задача 2 |
| `task_3/` | Задача 3 - многоклассовая классификация жанров по аудио-признакам |
| `task_3/notebooks/` | Ноутбуки и Python-модули задачи 3 |
| `task_3/data/splits/` | Зафиксированные train/val/test parquet-выборки (сплит 70/15/15). |
